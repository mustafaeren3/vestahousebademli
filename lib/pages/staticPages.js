...
export const INTERIOR_PAGES = [
  ...
  },
  {
    ...
    path: "/kahvalti",
    label: "Kahvaltı",
    // Faz 8: bu sayfaya özel, page_settings.is_active destekli tam sayfa
    // aç/kapa anahtarı. Diğer iç sayfalarda bilerek yok -- şimdilik yalnızca
    // Kahvaltı için isteniyor; admin/pages/PageManager.jsx bu bayrağı
    // görürse üstte bir "Sayfa Aktif" toggle'ı render eder.
    pageActiveToggle: true,
    fallback: {
      eyebrow: "Kahvaltı",
